...
app.controller('employeeController', [
    ...
    function ($scope, $rootScope, $window, cookie, uiGridConstants, hrmAPIservice, $interval, $location, fileService, fileService2) {
        ...
        $scope.LQEditFlag = false;   // if click edit link on L/Q data
        ...
        console.log(perm);
        if (perm['5'] == null || perm['5']==undefined)      $scope.isAllowed = false;
        else {
        ...
        $scope.editEmployee = function (empDetail) {
            ...
            .then(function(response){
                ...
                console.log($scope.selectedEmpDetail);
...
*/
        ...
        const populateLicence = function(log, enableForm){
            console.log(log);
