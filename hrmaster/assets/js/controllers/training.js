app.controller("trainingController", ["$scope", "$rootScope", "cookie", "$location", "hrmAPIservice", function($scope, $rootScope, cookie, $location, hrmAPIservice) {
    ...
    if (perm['13'] == null || perm['13']==undefined)      $scope.isAllowed = false;
    else {
