app.controller('injuryregisterController', ['$scope', '$rootScope', 'cookie','uiGridConstants', '$location', 'hrmAPIservice', 'fileService',  function ($scope, $rootScope, cookie, uiGridConstants, $location, hrmAPIservice, fileService) {
    ...
    console.log(perm);
    if (perm['38'] == null || perm['38']==undefined)      $scope.isAllowed = false;
    else {
    ...
    $scope.gridOptionsComplex = {
        ...
        columnDefs: [
          ...
          { name: 'action', enableFiltering: false, width: '10%',  cellClass: 'center', enableCellEdit: false,
              ...
              cellTemplate: '<div class="ui-grid-cell-contents grid-center-cell" ><span ng-click="grid.appScope.editInjury(row.entity)" ng-if="row.entity.write == 1"><span class="glyphicon glyphicon-edit text-edit"></span></span>&nbsp;&nbsp;&nbsp;<span ng-click="grid.appScope.deleteInjury(row.entity)" ng-if="row.entity.delete == 1"><span class="glyphicon glyphicon-trash text-danger"></span></span></div>'
