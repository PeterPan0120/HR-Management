    ...
    while($rm_table->getRow()){
        ...
        switch($row["email_name"]){
            ...
            case "Training Course Due": {
                ...
                $sql = "SELECT * from alloc_course where user_id=".$row['account_id'];
            ...
            case "Performance Review": {
                ...
                $sql = "SELECT pf.*, fr.* FROM performance_forms pf JOIN form_reviews fr ON pf.id=fr.p_forms_id WHERE pf.account_id=".$row['account_id']." AND fr.form_status='pending'";
